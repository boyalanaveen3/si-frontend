          ...
          <div className="flex-1 space-y-6">
            ...
            <Reveal delay={0.1}>
              <p className="section-subtitle text-slate-600">
                Share your goals, and we'll craft a digital roadmap that blends marketing, design, and technology to accelerate measurable outcomes.
              </p>
            </Reveal>  
            <Reveal delay={0.2}>
              <div className="grid gap-6 sm:grid-cols-2">
                <div className="rounded-3xl border border-white/40 bg-white/80 p-6 shadow-lg backdrop-blur">
                  ...
                  <p className="mt-2 text-sm text-slate-600">Drop us a line and we'll respond within a business day.</p>
          ...
          <Reveal delay={0.1}>
            <div className="space-y-6 rounded-3xl border border-slate-200 bg-white p-8 shadow-lg">
              ...
              <div className="rounded-2xl bg-slate-50 p-4 text-xs text-slate-500">
                "Within two quarters, Visionary Hub transformed our fragmented channels into a unified growth engine. Pipeline velocity doubled and customer retention improved 18%."
              </div>
